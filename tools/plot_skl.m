function plot_skl(X,Y,Z,plotstr,linestr)
%{
    绘制一帧对齐的骨架点
%}
%% 画点
...
% Z = XYZ(3:3:end);
for k = 1:size(X,1)
    plot3(X(k,1),Y(k,1),Z(k,1),'o','Color',plotstr,...
        'MarkerSize',2,'MarkerFaceColor',plotstr)
    hold on
end
hold off
%% 划线
...
drawline = [ 1 2; 1 3;2 3; 4 5;4 6;5 7;6 8;7 14;8 14;...
    5 9;7 11;6 10; 8 12;14 15; 15 16;13 5;13 6;13 7;13 8];
temp = [X,Y,Z]';
