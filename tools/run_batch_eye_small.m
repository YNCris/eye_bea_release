...
addpath(genPath)
%% set save path
savepath = ['X:\hanyaning\human_gaze\data_20241119\struct_small'];
mkdir(savepath)
%% get filename
...
for iData = 1:size(fileNames,1)
    ...
    %% Import dataset
    BeA.DataInfo.VideoInfo.FrameRate = 20;
    ...
    BeA.BeA_DecData.XY = [...
        BeA.RawData.X(1:50:end),...
        BeA.RawData.Y(1:50:end)]';
    ...
    BeA_DecParam.L2.nMi = 500; % Minimum lengths (ms),raw 100
